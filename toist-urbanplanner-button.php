...
<script type="text/javascript">
	if(typeof QTags !== 'undefined'){
		...
		function planner_maker(e,c,ed){
			...
			var ymd = d.getFullYear() + '-' + (d.getMonth()+1) + '-' + (d.getDate()+1);
			var ymdTomorrow = d.getFullYear() + '-' + (d.getMonth()+1) + '-' + (d.getDate()+2);
			var ymdTwoDays = d.getFullYear() + '-' + (d.getMonth()+1) + '-' + (d.getDate()+3);
			var ymdThreeDays = d.getFullYear() + '-' + (d.getMonth()+1) + '-' + (d.getDate()+4);
		...
		function weekend_planner_maker(e,c,ed){
			...
			var ymdTwoDays = d.getFullYear() + '-' + (d.getMonth()+1) + '-' + (d.getDate()+3);
			var ymdThreeDays = d.getFullYear() + '-' + (d.getMonth()+1) + '-' + (d.getDate()+4);
			var ymdFourDays = d.getFullYear() + '-' + (d.getMonth()+1) + '-' + (d.getDate()+5);
			var strTwoDays = weekday[(d.getDay() + 2) % 7];
			var strThreeDays = weekday[(d.getDay() + 3) % 7];
